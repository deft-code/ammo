...
namespace ammo
{
  bool GUIManager::Initialize(sf::RenderWindow* Win)
  {
    ...
    try
    {
      mRenderer = new CEGUI::OpenGLRenderer(0, Win->GetWidth(), Win->GetHeight());
      mSystem = new CEGUI::System(mRenderer);
      CEGUI::SchemeManager::getSingleton().loadScheme("data/gui/WindowsLook.scheme");
      CEGUI::FontManager::getSingleton().createFont("data/gui/DejaVuSans-10.font");
